            ...
            <div class="ulogo">
                <a href="index.html">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <img src="{{ asset('admin_ui/images/logo-dark.png') }}" alt="">
                        <h3><b>Starby </b></h3>
                    </div>
                </a>
            </div>
            ...
            <li class="treeview {{ $prefix == '/category' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $route == 'all.subCategory' ? 'active' : '' }}"><a
                            href="{{ route('all.subCategory') }}"><i class="ti-more"></i>All Sub Categories</a></li>
                    <li class="{{ $route == 'all.sub.subCategory' ? 'active' : '' }}"><a
                            href="{{ route('all.sub.subCategory') }}"><i class="ti-more"></i>All Sub Subcategories</a>
                    </li>
                </ul>
            </li>
