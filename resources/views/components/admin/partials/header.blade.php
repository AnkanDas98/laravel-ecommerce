            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0"
                        ...
                        <img src="{{ $adminData->profile_image ? asset('storage/' . $adminData->profile_image) : asset('storage/images/no_profile.png') }}"
                            alt="User Avatar">
                    </a>
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            ...
                            <a class="dropdown-item" href="{{ route('admin.profile.password.edit') }}"><i
