<x-frontend.layouts.master>
    <x-slot name='pageTitle'>
        {{ session()->get('language') == 'bangla' ? $product->product_name_bn : $product->product_name_en }}</x-slot>
                                        ...
                                        @foreach ($multiImages as $image)
                                            <div class="single-product-gallery-item" id="slide{{ $image->id }}">
                                                <a data-lightbox="image-1" data-title="Gallery"
                                                    href="{{ asset('storage/' . $image->product_image) }}">
                                                    <img class="img-responsive" alt=""
                                                        src="{{ asset('storage/' . $image->product_image) }}"
                                                        data-echo="{{ asset('storage/' . $image->product_image) }}" />
                                                </a>
                                                ...
                                                <div class="item">
                                                    <a class="horizontal-thumb active" data-target="#owl-single-product"
                                                        ...
                                                        <img class="img-responsive" width="85"
                                                            alt="{{ $image['product']['product_name_en'] }}"
                                                            src="{{ asset('storage/' . $image->product_image) }}"
                                                            data-echo="{{ asset('storage/' . $image->product_image) }}" />
                                                    </a>
                                                </div>
                                    ...
                                    <div class="stock-container info-container m-t-10">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="stock-box">
                                                    <span
                                                        class="value">{{ $product->product_qty > 0 ? 'In Stock' : 'Not In Stock' }}</span>
                                                </div>
                                            </div>
                                        </div><!-- /.row -->
                                    </div><!-- /.stock-container -->
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="description" class="tab-pane in active">
                                        <div class="product-tab">
                                            {!! session()->get('language') == 'bangla' ? $product->long_descp_bn : $product->long_descp_en !!}
                                        </div>
                                    </div><!-- /.tab-pane -->
                                    ...
                                    <div id="review" class="tab-pane">
                                        <div class="product-tab">
                                            ...
                                            <div class="product-add-review">
                                                <h4 class="ti tle">Write your own review</h4>
